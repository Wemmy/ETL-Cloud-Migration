...
class fmp_data:
    ...
    def get_historical_data(self,*args, **kwargs):
        ...
        '''
        # print(self._build_url('v3', 'historical-price-full',*args, **kwargs))
...
if __name__ == "__main__":
    ...
    # fmp_data = fmp_data('test')

    # get all tradable search
    '''
    [
        {
            "symbol": "0Y9S.L",
    ...
    '''
    # or use market screener
    # all_tradable_symble = fmp_data.get_tradable_search()

    # # get relevant company info
    # tickers = []
    # all_company_profile = [fmp_data.get_company_profile for t in tickers]
    dt_now = datetime.now(tz=timezone.utc)- timedelta(days=2)
    print(dt_now)
    # get market cap

    # get company rating

    # yearly or quarterly income/balance sheet/cashflow financial
